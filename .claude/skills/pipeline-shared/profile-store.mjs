...
//
// Peter, 2026-08-19: "create a dashboards/profiles folder that is gonna be
...
//     they in the ICP?" It NEVER opens a profile page (Peter, 2026-08-19:
...
// Both pipelines' profile files live here (Peter, 2026-08-19).
...
export function openProfileStore(dir, {
  ...
  const set = (pkey, headline, v = {}) => {
    ...
    // one date Peter asked for meaningless.
